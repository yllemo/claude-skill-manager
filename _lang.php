...
function skill_lang_builtin_all(): array {
    ...
    $sv = [
        ...
        'index.upload_title' => 'Tillåtna filtyper i arkiven: {exts}',
        ...
        'index.msg_zip_ok' => 'Zip-filen sparades som <strong>{file}</strong> (endast tillåtna filtyper ingår: {exts}).',
        ...
        'view.canvas_btn' => 'Skill Canvas',
        'view.canvas_title' => 'Öppna skill på whiteboard (Skill Canvas)',
        'view.chat_btn' => 'Chat',
        'view.chat_title' => 'Chatta med skill-innehållet',
        ...
        'view.open_new_tab' => 'Filen öppnas i en ny flik.',
        ...
        'err.forbidden_file' => 'Otillåten fil i arkivet: {name} (tillåtna: {exts}).',
    ...
    $en = [
        ...
        'index.upload_title' => 'Allowed file types in archives: {exts}',
        ...
        'index.msg_zip_ok' => 'Zip saved as <strong>{file}</strong> (only allowed types included: {exts}).',
        ...
        'view.canvas_btn' => 'Skill Canvas',
        'view.canvas_title' => 'Open skill on whiteboard (Skill Canvas)',
        'view.chat_btn' => 'Chat',
        'view.chat_title' => 'Chat with skill content',
        ...
        'view.copy' => 'Copy',
        'view.copied' => 'Copied',
        'view.open_new_tab' => 'The file opens in a new tab.',
        ...
        'err.forbidden_file' => 'Forbidden file in archive: {name} (allowed: {exts}).',

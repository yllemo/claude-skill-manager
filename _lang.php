...
function skill_lang_builtin_all(): array {
    ...
    $sv = [
        ...
        'settings.tabs_aria' => 'Inställningsflikar',
        'settings.tab_access' => 'Åtkomst & användare',
        'settings.tab_links' => 'Länkar & idéer',
        'settings.tab_git' => 'Git-synk',
        'settings.links_intro' => 'Samla externa repos, skill-samlingar och sidor — samt idéer till framtida skills — på ett ställe. Endast synligt för administratörer.',
        'settings.links_add' => 'Lägg till länk eller idé',
        'settings.links_edit' => 'Redigera post',
        'settings.links_add_btn' => 'Lägg till',
        'settings.links_section_list' => 'Lista',
        'settings.links_col_title' => 'Titel',
        'settings.links_col_url' => 'URL',
        'settings.links_col_type' => 'Typ',
        'settings.links_col_status' => 'Status',
        'settings.links_col_tags' => 'Taggar',
        'settings.links_col_sort' => 'Sortering',
        'settings.links_col_notes' => 'Anteckningar',
        'settings.links_title_placeholder' => 't.ex. Mermaid diagram-skill',
        'settings.links_notes_placeholder' => 'Idé, kontext, varför det är intressant…',
        'settings.links_url_hint' => 'Valfri för typen Idé. Obligatorisk för repo, samling och sida.',
        'settings.links_type_repo' => 'Repo',
        'settings.links_type_collection' => 'Samling',
        'settings.links_type_page' => 'Sida',
        'settings.links_type_idea' => 'Idé (planerad skill)',
        'settings.links_status_active' => 'Aktiv',
        'settings.links_status_planned' => 'Planerad',
        'settings.links_status_done' => 'Klar / skapad',
        'settings.links_status_archived' => 'Arkiverad',
        'settings.links_filter_all' => 'Alla',
        'settings.links_empty' => 'Inga poster ännu. Lägg till en länk eller en idé ovan.',
        'settings.links_added' => 'Posten lades till.',
        'settings.links_updated' => 'Posten uppdaterades.',
        'settings.links_deleted' => 'Posten raderades.',
        'settings.links_confirm_delete' => 'Radera “{title}”?',
        'settings.links_err_title' => 'Titel krävs.',
        'settings.links_err_url' => 'URL krävs för denna typ (inte för idéer).',
        'settings.links_err_not_found' => 'Posten hittades inte.',
        'settings.git_intro' => 'Synka alla .skill-filer under <code>content/</code> till ett GitHub- eller GitLab-repo via API (token). Endast administratörer. Baserat på <a href="https://github.com/yllemo/php-git-simple" target="_blank" rel="noopener">php-git-simple</a>.',
        'settings.git_section_connection' => 'Anslutning',
        'settings.git_section_sync' => 'Synka content',
        'settings.git_enabled' => 'Aktivera Git-synk',
        'settings.git_enabled_hint' => 'Måste vara på för att synk-knappen ska fungera.',
        'settings.git_provider' => 'Provider',
        'settings.git_gitlab_url' => 'GitLab-URL',
        'settings.git_gitlab_url_hint' => 'Lämna https://gitlab.com eller ange self-hosted-instans.',
        'settings.git_owner' => 'Ägare / namespace',
        'settings.git_repo' => 'Repo-namn',
        'settings.git_branch' => 'Branch',
        'settings.git_path_prefix' => 'Sökväg i repo',
        'settings.git_path_prefix_hint' => 'Mapp där .skill sparas (t.ex. content). Tom = repo-rot.',
        'settings.git_token' => 'API-token',
        'settings.git_token_placeholder' => 'ghp_… / glpat-…',
        'settings.git_token_keep' => 'Lämna tomt för att behålla sparad token',
        'settings.git_token_hint' => 'GitHub: Contents Read and write. GitLab: read_repository + write_repository. Lagras i config/git.php.',
        'settings.git_commit_message' => 'Commit-meddelande (bas)',
        'settings.git_delete_missing' => 'Ta bort fjärr-.skill som saknas lokalt',
        'settings.git_delete_missing_hint' => 'Om ikryssad raderas .skill under sökvägen i git som inte finns i content/.',
        'settings.git_save' => 'Spara Git-inställningar',
        'settings.git_test' => 'Testa anslutning',
        'settings.git_saved' => 'Git-inställningarna sparades.',
        'settings.git_test_ok' => 'Anslutning OK: {repo} (branch {branch}).',
        'settings.git_test_fail' => 'Anslutning misslyckades: {error}',
        'settings.git_sync_intro' => 'Pushar {n} lokal(a) .skill-fil(er) till det konfigurerade repot. Oförändrade filer hoppas över.',
        'settings.git_last_sync' => 'Senaste synk: {when} ({status}) — {summary}',
        'settings.git_sync_confirm' => 'Synka alla .skill under content/ till git nu?',
        'settings.git_sync_btn' => 'Synka content → Git',
        'settings.git_sync_disabled_title' => 'Aktivera och spara anslutning först',
        'settings.git_sync_ok' => 'Synk klar.',
        'settings.git_sync_partial' => 'Synk klar med vissa fel — se loggen.',
        'settings.git_sync_fail' => 'Synk misslyckades.',
        'settings.git_sync_summary' => 'Skapade {created}, uppdaterade {updated}, hoppade över {skipped}, raderade {deleted}, fel {errors}.',
        'settings.git_log_create' => '+ skapade {file}',
        'settings.git_log_update' => '~ uppdaterade {file}',
        'settings.git_log_skip' => '= oförändrad {file}',
        'settings.git_log_delete' => '− raderade {file}',
        'settings.git_err_incomplete' => 'Token, ägare och repo måste fyllas i.',
        'settings.git_err_disabled' => 'Git-synk är avstängd. Aktivera den under anslutning.',
        'settings.git_err_empty' => 'Tom fil: {file}',
        'settings.git_err_list_remote' => 'Kunde inte lista fjärrfiler: {error}',
    ];
    ...
    $en = [
        ...
        'settings.tabs_aria' => 'Settings tabs',
        'settings.tab_access' => 'Access & users',
        'settings.tab_links' => 'Links & ideas',
        'settings.tab_git' => 'Git sync',
        'settings.links_intro' => 'Collect external repos, skill collections and pages — plus ideas for future skills — in one place. Visible to administrators only.',
        'settings.links_add' => 'Add link or idea',
        'settings.links_edit' => 'Edit entry',
        'settings.links_add_btn' => 'Add',
        'settings.links_section_list' => 'List',
        'settings.links_col_title' => 'Title',
        'settings.links_col_url' => 'URL',
        'settings.links_col_type' => 'Type',
        'settings.links_col_status' => 'Status',
        'settings.links_col_tags' => 'Tags',
        'settings.links_col_sort' => 'Sort order',
        'settings.links_col_notes' => 'Notes',
        'settings.links_title_placeholder' => 'e.g. Mermaid diagram skill',
        'settings.links_notes_placeholder' => 'Idea, context, why it matters…',
        'settings.links_url_hint' => 'Optional for Idea type. Required for repo, collection and page.',
        'settings.links_type_repo' => 'Repo',
        'settings.links_type_collection' => 'Collection',
        'settings.links_type_page' => 'Page',
        'settings.links_type_idea' => 'Idea (planned skill)',
        'settings.links_status_active' => 'Active',
        'settings.links_status_planned' => 'Planned',
        'settings.links_status_done' => 'Done / created',
        'settings.links_status_archived' => 'Archived',
        'settings.links_filter_all' => 'All',
        'settings.links_empty' => 'No entries yet. Add a link or idea above.',
        'settings.links_added' => 'Entry added.',
        'settings.links_updated' => 'Entry updated.',
        'settings.links_deleted' => 'Entry deleted.',
        'settings.links_confirm_delete' => 'Delete “{title}”?',
        'settings.links_err_title' => 'Title is required.',
        'settings.links_err_url' => 'URL is required for this type (not for ideas).',
        'settings.links_err_not_found' => 'Entry not found.',
        'settings.git_intro' => 'Sync all .skill files under <code>content/</code> to a GitHub or GitLab repo via API token. Admins only. Based on <a href="https://github.com/yllemo/php-git-simple" target="_blank" rel="noopener">php-git-simple</a>.',
        'settings.git_section_connection' => 'Connection',
        'settings.git_section_sync' => 'Sync content',
        'settings.git_enabled' => 'Enable Git sync',
        'settings.git_enabled_hint' => 'Must be on for the sync button to work.',
        'settings.git_provider' => 'Provider',
        'settings.git_gitlab_url' => 'GitLab URL',
        'settings.git_gitlab_url_hint' => 'Leave https://gitlab.com or set your self-hosted instance.',
        'settings.git_owner' => 'Owner / namespace',
        'settings.git_repo' => 'Repository name',
        'settings.git_branch' => 'Branch',
        'settings.git_path_prefix' => 'Path in repo',
        'settings.git_path_prefix_hint' => 'Folder where .skill files are stored (e.g. content). Empty = repo root.',
        'settings.git_token' => 'API token',
        'settings.git_token_placeholder' => 'ghp_… / glpat-…',
        'settings.git_token_keep' => 'Leave blank to keep saved token',
        'settings.git_token_hint' => 'GitHub: Contents Read and write. GitLab: read_repository + write_repository. Stored in config/git.php.',
        'settings.git_commit_message' => 'Commit message (base)',
        'settings.git_delete_missing' => 'Delete remote .skill files missing locally',
        'settings.git_delete_missing_hint' => 'If checked, .skill under the repo path that are not in content/ are deleted.',
        'settings.git_save' => 'Save Git settings',
        'settings.git_test' => 'Test connection',
        'settings.git_saved' => 'Git settings saved.',
        'settings.git_test_ok' => 'Connection OK: {repo} (branch {branch}).',
        'settings.git_test_fail' => 'Connection failed: {error}',
        'settings.git_sync_intro' => 'Pushes {n} local .skill file(s) to the configured repo. Unchanged files are skipped.',
        'settings.git_last_sync' => 'Last sync: {when} ({status}) — {summary}',
        'settings.git_sync_confirm' => 'Sync all .skill files under content/ to git now?',
        'settings.git_sync_btn' => 'Sync content → Git',
        'settings.git_sync_disabled_title' => 'Enable and save connection first',
        'settings.git_sync_ok' => 'Sync finished.',
        'settings.git_sync_partial' => 'Sync finished with some errors — see log.',
        'settings.git_sync_fail' => 'Sync failed.',
        'settings.git_sync_summary' => 'Created {created}, updated {updated}, skipped {skipped}, deleted {deleted}, errors {errors}.',
        'settings.git_log_create' => '+ created {file}',
        'settings.git_log_update' => '~ updated {file}',
        'settings.git_log_skip' => '= unchanged {file}',
        'settings.git_log_delete' => '− deleted {file}',
        'settings.git_err_incomplete' => 'Token, owner and repo are required.',
        'settings.git_err_disabled' => 'Git sync is disabled. Enable it under Connection.',
        'settings.git_err_empty' => 'Empty file: {file}',
        'settings.git_err_list_remote' => 'Could not list remote files: {error}',
    ];
